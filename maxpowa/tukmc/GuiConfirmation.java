...
public class GuiConfirmation extends GuiScreen {
	...
	public GuiConfirmation(Minecraft mc, String bodyText, String action, GuiScreen parent) {
		fr = mc.fontRenderer;
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiTukButton(101, width/2-101, height/2+55, 100, 20, "I understand."));
		this.buttonList.add(new GuiTukButton(102, width/2+2, height/2+55, 98, 20, "Get me outta here!"));
	}
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		List bodyList = mc.fontRenderer.listFormattedStringToWidth(bodyText, 175);
		int i = 0;
		for (Object o : bodyList) {
			String s = (String)o;
			fr.drawString(s, (width/2-(fr.getStringWidth(s)/2)), (height/2-51+(10*i)), 0xFFFFFF);
			i++;
		}
	}
